...
export function prototypeReadiness() {
  ...
  if (!persistentDemoConfigured) {
    ...
    nextSafeStep = 'Run repeated simulated transfers, replay a duplicate request, reconcile transaction history and double-entry balances, validate persistent Safe-to-Spend and Bill Guard data, and capture evidence for partner/investor diligence.';
  }
