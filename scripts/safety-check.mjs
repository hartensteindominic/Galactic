...
const required = [
  ...
  ['app/layout.tsx', 'Galactic Trust | Online Banking Experience Demo', 'browser metadata must clearly identify the product as an online banking experience demo'],
  ['app/layout.tsx', 'Real financial services require an approved regulated partner program.', 'browser metadata must preserve the regulated-program boundary'],
...
const forbidden = [
  ...
  ['app/layout.tsx', 'Member FDIC', 'metadata must not claim FDIC membership without an approved program'],
  ['app/layout.tsx', 'FDIC insured', 'metadata must not claim deposit insurance without approved program language'],
  ['app/layout.tsx', 'chartered bank', 'metadata must not imply Galactic Trust itself is already a chartered bank'],
